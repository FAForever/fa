...
function ConfigureUpgrades()
    ...
    -- The 6 icons showing which upgrades the sACU will receive
...
-- Get any idle sACU that isn't already a combat or engineer sACU
...
-- Check for idle sACUs, then start the relevant upgrade on them
...
-- Tell the sACU what type it now is, and upgrade it
