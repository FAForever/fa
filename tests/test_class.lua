...
luft.describe("Test class system", function()
    luft.describe("Basic class tests", function()
        luft.test("Basic inheritance", function()
            local Specs = {
        ...
        luft.test("Basic dual inheritance", function()
            local Specs = {
                OnCreate = function() end;
                OnDestroy = function() end;
            }
        ...
        luft.test("Basic override", function()
            local Specs = {
                GetPosition = function() end;
                OnCreate = function() end;
                OnDestroy = function() end;
        ...
        luft.test("Basic self value", function()
            local Specs = {
                OnCreate = function() end;
                OnDestroy = function() end;
            }
