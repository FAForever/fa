...
loadingtip_0030="Units on Attack-Move will stop to follow and attack enemy units in their weapon range"
...
loadingtip_0040="Stealth only hides units from radar and Cloaking only from vision, but omni sees through both"
...
loadingtip_0046="Use your ACU to secure groups of mass points and engage in combat in the early game"
loadingtip_0047="Don't be too reckless with your ACU (it can be very useful in combat without being suicidal)"
loadingtip_0048="Keep scouting throughout the game; having intelligence on your enemy can be key to victory"
...
loadingtip_0054="Manually placing Reclaim orders is generally not considered a good use of your time after the early game"
...
loadingtip_0062="If the enemy's eco is a lot better than yours, you can generally attack them and take winning battles"
...
loadingtip_0067="Manually reclaiming can be useful during the very early game if you have nothing better to do"
...
loadingtip_0072="It can be worthwhile to reclaim your old low-tech units to get additional mass"
loadingtip_0073="Think about value and opportunity costs (e.g. would you rather have ~16 T1 tanks or 1 T2 mex?)"
...
loadingtip_0092="Avoid stalling energy (don't get to 0 energy in storage with a negative net energy income)"
loadingtip_0093="It's better to spend mass than let it sit in storage"
loadingtip_0094="Avoid building too many Power Generators (extra Power Generators cost resources that can be better spent)"
...
loadingtip_0099="If you don't think your team can win anymore, you can use the Recall feature to request an end to the battle"
loadingtip_0100="You can find other players to talk about FAF or team up with on the FAF Discord"
