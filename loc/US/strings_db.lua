...
lobui_CAUponDisconnectDescription="Initially each player has their own army and their own resources. When a player disconnects the army is not considered defeated. Instead, allied players can switch focus to the disconnected army to issue commands."
