...
OPTIONS_0281="Show hotkeylabels for hotbuild and order keys"
OPTIONS_0282="Shows the shortcut keys you use for hotbuild on top of the unit images in the construction tab and keys for orders on the order buttons"
