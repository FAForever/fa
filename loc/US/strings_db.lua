...
key_binding_0024="Are you sure you want to reset all key bindings to the alternative (FAF) preset? (begginer friendly)"
key_binding_0025="Alternative Preset"
key_binding_0026="Reset all key bindings to the alternative (FAF) preset (begginer friendly)"
...
key_desc_0400="build point defenses + walls"
...
loadingtip_0001="At least one Energy Storage and 5000 energy is required to fire the ACU’s Overcharge cannon"
...
loadingtip_0035="Overcharge can deal up to 15,000 damage to a unit, depending on your energy stock"
