...
Unit_Description_0011="Creates a Bubble Shield around the ACU, which protects friendly units in its radius. If present, the shield will transfer a portion of the damage received to intersecting bubbles. Requires energy to run."
