    ...
    OnKilled = function(self, instigator, type, overkillRatio)
        ...
        if self:GetFractionComplete() >= 1.0 then
            ...
            TrashBagAdd(trash,
                ...
                :SetEmitterParam('REPEATTIME', Random(20, 40))
            )
            ...
            CreateLightParticleIntel(self,'Spinner01', army, 0.15 + 0.05 * Random(2, 4), Random(3, 6), 'debris_alpha_03', 'ramp_antimatter_01')
            CreateLightParticleIntel(self,'Spinner02', army, 0.15 + 0.05 * Random(2, 4), Random(3, 6), 'debris_alpha_03', 'ramp_antimatter_01')
        end
    end,
}
