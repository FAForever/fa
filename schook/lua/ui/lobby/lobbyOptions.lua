...
globalOpts = {
	...
	{
        default = 1,
        label = "Recall Conditions",
        help = "Determines whether ACUs will recall when in danger",
        key = 'Recall',
        pref = 'Recall',
        values = {
            {
                text = "Recall Disabled",
                help = "ACUs will not be recalled",
                key = 'no',
            },
            {
                text = "Recall Enabled",
                help = "ACU Recall is enabled",
                key = 'yes',
            },
        },
    },
