...
This also shows that if you play on fafdevelop and encounter issues, it is very important that you actually report the issues to us. The desync issue was online on fafdevelop for a few weeks and we heard nothing. Testing and reporting issues is really crucial to ensure a smooth release.
...
- (#6533) Add support to assign hotkeys to secondary mouse buttons
...
- (https://github.com/FAForever/FA-Binary-Patches/pull/96) Add ability to bind side mouse buttons
