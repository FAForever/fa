...
lobui_0202="%s has joined as an observer." -- Removed by Xinnony
...
lobui_0224="Remove"
lobui_0226="%s has switched from a player to an observer." -- Removed by Xinnony
lobui_0227="%s has switched from an observer to player." -- Removed by Xinnony
lobui_0228="Observe"
