- (#7141) Make SACUs easier to access with reduced infrastructure costs and make them more powerful with a general cost reduction for SACUs and targeted adjustments for weaker upgrades (engineering upgrades, UEF bubble shield, Seraphim Overcharge).
