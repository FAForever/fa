...
And as my motivation to contribute towards the FAForever project dwindles I've decided to proceed to step down a few months ago. This created a window for contributors to step up and eventually BlackYps decided to do so. He's been contributing towards the FAForever project for several years now. He's a board member of the association. In general he has the right character and intentions. And I am looking forward to what he'll do with the role.
