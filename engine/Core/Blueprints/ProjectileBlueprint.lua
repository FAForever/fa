...
---@field StraightDownOrdinance boolean bombs that always drop stright down RProjectileBlueprint    DevStatus   Development Status  Display Display information for the Projectile  Economy Economy information for the unit    Physics Physics information for the Projectile