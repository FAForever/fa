...
local AIBrainChatComponent = import("/lua/aibrains/components/chat.lua").AIBrainChatComponent
...
---@class AIBrain: FactoryManagerBrainComponent, StatManagerBrainComponent, JammerManagerBrainComponent, EnergyManagerBrainComponent, StorageManagerBrainComponent, AIBrainChatComponent, moho.aibrain_methods
---@field AI boolean
...
AIBrain = Class(FactoryManagerBrainComponent, StatManagerBrainComponent, JammerManagerBrainComponent,
    EnergyManagerBrainComponent, StorageManagerBrainComponent, AIBrainChatComponent, moho.aibrain_methods) {
