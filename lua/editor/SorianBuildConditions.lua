...
function IsIslandMap(aiBrain, bool)
    ...
    local path, reason, pathDistance = false
    if enemyX then
        path, reason, pathDistance = AIAttackUtils.PlatoonGenerateSafePathToNavMesh(aiBrain, 'Land', {startX,0,startZ}, {enemyX,0,enemyZ}, 10)
    end
