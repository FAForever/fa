...
--****************************************************************************
--
-- One cautionary note: dont change the playable area during an in-game cinematic.
...
-- Zoom is measured in LOD units.  Its the value of the width of the view frustum
-- at the focus point
...
-- Used by other functions to make sure that they dont return
