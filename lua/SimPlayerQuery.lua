...
function AddQueryListener( queryName, listener )
    tableInsert( QueryListeners, { Name=queryName, Listener=listener } )
end
...
function AddResultListener( queryName, listener )
    tableInsert( ResultListeners, { Name=queryName, Listener=listener } )
end
...
function OnPlayerQuery( queryData )
    ...
    tableInsert(Sync.PlayerQueries, queryData )
end
...
function OnPlayerQueryResult( resultData )
    ...
    tableInsert(Sync.QueryResults, resultData)
end
