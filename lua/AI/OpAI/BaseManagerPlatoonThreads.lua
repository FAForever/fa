...
function CanConditionalBuild(singleEngineerPlatoon)
    ...
    local canPermanentAssist = EntityCategoryContains( categories.ENGINEER - ( categories.COMMAND + categories.SUBCOMMANDER ), engineer )
...
function DoConditionalBuild(singleEngineerPlatoon)
    ...
    -- bManager.ConditionalBuildData.NumToBuild = selectedBuild.data.Amount or 1
