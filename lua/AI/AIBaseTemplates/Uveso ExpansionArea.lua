...
--        'Strategic Missile Launcher NukeAI Uveso',
    ...
    ExpansionFunction = function(aiBrain, location, markerType)
        ...
        --LOG('*** E-ExpansionFunction: personality: [ '..personality..' ] - markerType: [ '..markerType..' ] - Uveso ExpansionArea.lua')
        if personality == 'UvesoReflectiveFull' then
            ...
            then
                LOG('---- E-ExpansionFunction: UNKNOWN EXPANSION TYPE! personality: [ '..personality..' ] - markerType: [ '..markerType..' ] - Uveso ExpansionArea.lua')
            end
        end
        return -1
    end,
