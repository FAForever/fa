...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.MASSEXTRACTION } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconIncomeOverTime',  { 3.5, 10}},
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.6, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 2, categories.MASSEXTRACTION } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconIncomeOverTime',  { 20, 10}},
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.6, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 2, categories.MASSEXTRACTION } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconIncomeOverTime',  { 2.2, 10}},
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.6, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.MASSEXTRACTION } },
        },
        FormRadius = 10000,
    ...
    Builder {
        ...
        BuilderConditions = {
            --{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 1, categories.ENERGYPRODUCTION * ( categories.TECH2 + categories.TECH3 ) } },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.MASSEXTRACTION * categories.TECH3 } },
            { EBC, 'GreaterThanEconIncomeOverTime', { 13, 50 } },
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2 }},
            --{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 5, categories.MASSEXTRACTION }},
        },
    ...
    Builder {
        ...
        BuilderConditions = {
            --{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 1, categories.ENERGYPRODUCTION * ( categories.TECH2 + categories.TECH3 ) } },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 3, categories.MASSEXTRACTION * categories.TECH3 } },
            { EBC, 'GreaterThanEconIncomeOverTime', { 20, 50 } },
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2 }},
        },
        FormRadius = 10000,
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 2, categories.MASSEXTRACTION * categories.TECH3 } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2 }},
            { EBC, 'MassIncomeToUnitRatio', { 7, '>=', categories.FACTORY * categories.TECH1 * categories.STRUCTURE } },
            { EBC, 'MassIncomeToUnitRatio', { 14, '>=', categories.FACTORY * categories.TECH2 * categories.STRUCTURE } },
            { EBC, 'MassIncomeToUnitRatio', { 19, '>=', categories.FACTORY * categories.TECH3 * categories.STRUCTURE } },
            },
        BuilderType = 'Any',
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 300,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.FACTORY * categories.TECH3 } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.MASSEXTRACTION * categories.TECH3}},
                { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 1, categories.FACTORY } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsWithCategory', { 1, categories.FACTORY * categories.LAND * ( categories.TECH2 + categories.TECH3 ) } },
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.FACTORY * categories.LAND * ( categories.TECH2 + categories.TECH3 ) } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 3, categories.MASSEXTRACTION * ( categories.TECH2 + categories.TECH3 )}},
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 3, categories.MASSEXTRACTION * ( categories.TECH2 + categories.TECH3 )}},
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.FACTORY * categories.NAVAL * ( categories.TECH2 + categories.TECH3 )}},
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.FACTORY * categories.AIR * ( categories.TECH2 + categories.TECH3 ) } },
                { EBC, 'GreaterThanEconIncomeOverTime',  { 5, 75}},
            },
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        InstanceCount = 1,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.FACTORY * categories.LAND * ( categories.TECH2 + categories.TECH2 ) } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.FACTORY * categories.NAVAL * ( categories.TECH2 + categories.TECH3 )}},
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 4, categories.MASSEXTRACTION * ( categories.TECH2 + categories.TECH3 )}},
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 2, categories.FACTORY * ( categories.TECH2 + categories.TECH3 ) } },
    ...
    Builder {
        ...
        FormDebugFunction = nil,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.FACTORY * categories.AIR * ( categories.TECH2 + categories.TECH2 ) } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.FACTORY * categories.NAVAL * ( categories.TECH2 + categories.TECH3 )}},
...
BuilderGroup {
    ...
    Builder {
        ...
        InstanceCount = 1,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.FACTORY * categories.LAND * categories.TECH3 } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.MASSEXTRACTION * categories.TECH3}},
    ...
    Builder {
        ...
        InstanceCount = 1,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 3, categories.FACTORY * ( categories.TECH2 + categories.TECH3 ) } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.MASSEXTRACTION * categories.TECH3} },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.FACTORY * categories.TECH3 * categories.NAVAL }},
                { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 2, categories.FACTORY * ( categories.TECH2 + categories.TECH3 ) } },
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.FACTORY * categories.TECH3 } },
