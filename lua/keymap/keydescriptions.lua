...
keyDescriptions = {
    ...
    ['SaveCameraPosition1'] = 'Stores camera position 1',
    ['RestoreCameraPosition1'] = 'Restore camera position 1',
    ['SaveCameraPosition2'] = 'Stores camera position 2',
    ['RestoreCameraPosition2'] = 'Restore camera position 2',
    ['SaveCameraPosition3'] = 'Stores camera position 3',
    ['RestoreCameraPosition3'] = 'Restore camera position 3',
    ['SaveCameraPosition4'] = 'Stores camera position 4',
    ['RestoreCameraPosition4'] = 'Restore camera position 4',
    ['SaveCameraPosition5'] = 'Stores camera position 5',
    ['RestoreCameraPosition5'] = 'Restore camera position 5',
    ['SaveCameraPosition6'] = 'Stores camera position 6',
    ['RestoreCameraPosition6'] = 'Restore camera position 6',
    ['SaveCameraPosition7'] = 'Stores camera position 7',
    ['RestoreCameraPosition7'] = 'Restore camera position 7',
    ['SaveCameraPosition8'] = 'Stores camera position 8',
    ['RestoreCameraPosition8'] = 'Restore camera position 8',
    ['SaveCameraPosition9'] = 'Stores camera position 9',
    ['RestoreCameraPosition9'] = 'Restore camera position 9',
    ['SaveCameraPosition10'] = 'Stores camera position 10',
    ['RestoreCameraPosition10'] = 'Restore camera position 10',

    ['SaveUnitAsCameraPosition1'] = 'Store unit as camera position 1',
    ['RestoreUnitAsCameraPosition1'] = 'Store unit as camera position 1',
