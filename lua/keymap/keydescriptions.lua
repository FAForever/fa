...
keyDescriptions = {
    ...
    ['add_selection_set_to_selection1'] = 'Add control group 1 to the current selection',
    ['add_selection_set_to_selection2'] = 'Add control group 2 to the current selection',
    ['add_selection_set_to_selection3'] = 'Add control group 3 to the current selection',
    ['add_selection_set_to_selection4'] = 'Add control group 4 to the current selection',
    ['add_selection_set_to_selection5'] = 'Add control group 5 to the current selection',
    ['add_selection_set_to_selection6'] = 'Add control group 6 to the current selection',
    ['add_selection_set_to_selection7'] = 'Add control group 7 to the current selection',
    ['add_selection_set_to_selection8'] = 'Add control group 8 to the current selection',
    ['add_selection_set_to_selection9'] = 'Add control group 9 to the current selection',
    ['add_selection_set_to_selection0'] = 'Add control group 0 to the current selection',

    ['add_selection_to_selection_set1'] = 'Add current selection to control group 1',
    ['add_selection_to_selection_set2'] = 'Add current selection to control group 2',
    ['add_selection_to_selection_set3'] = 'Add current selection to control group 3',
    ['add_selection_to_selection_set4'] = 'Add current selection to control group 4',
    ['add_selection_to_selection_set5'] = 'Add current selection to control group 5',
    ['add_selection_to_selection_set6'] = 'Add current selection to control group 6',
    ['add_selection_to_selection_set7'] = 'Add current selection to control group 7',
    ['add_selection_to_selection_set8'] = 'Add current selection to control group 8',
    ['add_selection_to_selection_set9'] = 'Add current selection to control group 9',
    ['add_selection_to_selection_set0'] = 'Add current selection to control group 0',

    ['combine_and_select_with_selection_set1'] = 'Add current selection to control group 1 and select the control group',
    ['combine_and_select_with_selection_set2'] = 'Add current selection to control group 2 and select the control group',
    ['combine_and_select_with_selection_set3'] = 'Add current selection to control group 3 and select the control group',
    ['combine_and_select_with_selection_set4'] = 'Add current selection to control group 4 and select the control group',
    ['combine_and_select_with_selection_set5'] = 'Add current selection to control group 5 and select the control group',
    ['combine_and_select_with_selection_set6'] = 'Add current selection to control group 6 and select the control group',
    ['combine_and_select_with_selection_set7'] = 'Add current selection to control group 7 and select the control group',
    ['combine_and_select_with_selection_set8'] = 'Add current selection to control group 8 and select the control group',
    ['combine_and_select_with_selection_set9'] = 'Add current selection to control group 9 and select the control group',
    ['combine_and_select_with_selection_set0'] = 'Add current selection to control group 0 and select the control group',
