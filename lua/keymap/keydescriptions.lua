...
keyDescriptions = {
    ...
    ['move_persistent'] = '<LOC key_move_persistent>Persistent move order that can be re-issued without holding shift (right click to exit mode).',
    ['move_persistent_distributing_no_clear'] = '<LOC move_persistent_distributing>Persistent move order that breaks formations by distributing orders (shift version).',
