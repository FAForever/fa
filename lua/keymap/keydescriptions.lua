...
keyDescriptions = {
    ...
    ['select_all_building_eng'] = '<LOC key_desc_select_all_building_eng>Select all engineers that are consuming resources',
    ['select_all_building_eng_onscreen'] = '<LOC key_desc_select_all_building_eng_onscreen>Select all engineers that are consuming resources on screen',
