...
keyDescriptions = {
    ...
    ['select_all_resource_consumer'] = '<LOC key_desc_select_all_resource_consumer>Select all units that are requesting resources',
    ['select_all_resource_consumer_onscreen'] = '<LOC key_desc_select_all_resource_consumer_onscreen>Select all units that are requesting resources on screen',
