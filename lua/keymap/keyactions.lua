...
keyActions = {
    ...
    ['Attack Move (mobile units only)'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").AttackMoveSelectedToCurrentMousePosition(true)',
        category = 'orders', order = 15,},
    ['Attack Move (mobile units only) SHIFT version'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").AttackMoveSelectedToCurrentMousePosition()',
