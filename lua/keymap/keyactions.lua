...
keyActions = {
    ...
    ['show_objective_screen'] = {action = 'UI_Lua import("/lua/ui/game/objectiveDetail.lua").ToggleDisplay()',
        category = 'ui', order = 23},
    ['toggle_repeat_build'] = {action = 'UI_Lua import("/modules/keymapping.lua").ToggleRepeatBuild()',
        category = 'orders', order = 1,},
    ...
    ['toggle_shield'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Shield")',
        category = 'orders', order = 6,},
    ['toggle_weapon'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Weapon")',
        category = 'orders', order = 7,},
    ['toggle_jamming'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Jamming")',
        category = 'orders', order = 8,},
    ['toggle_intel'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Intel")',
        category = 'orders', order = 9,},
    ['toggle_production'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Production")',
        category = 'orders', order = 10,},
    ['toggle_stealth'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Stealth")',
        category = 'orders', order = 11,},
    ['toggle_generic'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Generic")',
        category = 'orders', order = 12,},
    ['toggle_special'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Special")',
        category = 'orders', order = 13,},
    ['toggle_cloak'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleScript("Cloak")',
        category = 'orders', order = 14,},
    ['toggle_all'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleAllScript()',
        category = 'orders', order = 15,},
    ['teleport'] = {action = 'StartCommandMode order RULEUCC_Teleport',
        category = 'orders', order = 5,},
    ['military_overlay'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleOverlay("Military")',
        category = 'ui', order = 16,},
    ['intel_overlay'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleOverlay("Intel")',
        category = 'ui', order = 17,},
    ...
    ['select_all_naval_units_onscreen'] = {action = 'UI_SelectByCategory +inview NAVAL',
        category = 'selection', order = 18,},
    ['select_all_similar_units'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetSimilarUnits()',
        category = 'selection', order = 19,},
    ['select_next_land_factory'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetNextLandFactory()',
        category = 'selection', order = 20,},
    ['select_next_air_factory'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetNextAirFactory()',
        category = 'selection', order = 21,},
    ['select_next_naval_factory'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetNextNavalFactory()',
        category = 'selection', order = 22,},
    ['toggle_selectedinfo'] = {action = 'UI_Lua import("/modules/selectedinfo.lua").ToggleOn()',
        category = 'ui', order = 23,},
    ['toggle_selectedrings'] = {action = 'UI_Lua import("/modules/selectedinfo.lua").ToggleOverlayOn()',
        category = 'ui', order = 24,},
    ['toggle_cloakjammingstealth'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleCloakJammingStealthScript()',
        category = 'orders', order = 25,},
    ['toggle_intelshield'] = {action = 'UI_Lua import("/modules/keymapping.lua").toggleIntelShieldScript()',
        category = 'orders', order = 26,},
    ...
    ['select_all_mex'] = {action = 'UI_SelectByCategory MASSEXTRACTION',
        category = 'selection', order = 31,},
    ['select_nearest_idle_lt_mex'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetNearestIdleLTMex()',
        category = 'selection', order = 32,},
    ['acu_select_cg'] = {action = 'UI_Lua import("/modules/keymapping.lua").ACUSelectCG()',
        category = 'selection', order = 33,},
    ['acu_append_cg'] = {action = 'UI_Lua import("/modules/keymapping.lua").ACUAppendCG()',
        category = 'selection', order = 34,},
    ['select_nearest_idle_eng_not_acu'] = {action = 'UI_Lua import("/modules/keymapping.lua").GetNearestIdleEngineerNotACU()',
        category = 'selection', order = 35,},
    ['add_nearest_idle_engineers_seq'] = {action = 'UI_Lua import("/modules/keymapping.lua").AddNearestIdleEngineersSeq()',
        category = 'selection', order = 36,},
    ['cycle_idle_factories'] = {action = 'UI_Lua import("/modules/keymapping.lua").CycleIdleFactories()',
        category = 'selection', order = 37,},
    ['cycle_unit_types_in_sel'] = {action = 'UI_Lua import("/modules/keymapping.lua").CycleUnitTypesInSel()',
        category = 'selection', order = 38,},
    ['create_template_factory'] = {action = 'UI_Lua import("/modules/keymapping.lua").CreateTemplateFactory()',
        category = 'selection', order = 39,},
    ...
    ['select_air_no_transport'] = {action = 'UI_Lua import("/modules/keymapping.lua").airNoTransports()',
        category = 'selection', order = 64,},
    ['select_air_transport'] = {action = 'UI_Lua import("/modules/keymapping.lua").airTransports()',
        category = 'selection', order =65,},
    ['lock_zoom'] = {action = 'UI_Lua import("/modules/keymapping.lua").lockZoom()',
        category = 'camera', order = 666,},

    -- HOTBUILD
    ['builders'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Builders")',
        category = 'hotbuilding', order = 1101,},
    ['sensors'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Sensors")',
        category = 'hotbuilding', order = 1102,},
    ['shields'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Shields")',
        category = 'hotbuilding', order = 1103,},
    ['tmd'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("TMD")',
        category = 'hotbuilding', order = 1104,},
    ['xp'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("XP")',
        category = 'hotbuilding', order = 1105,},
    ['mobilearty'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Arty")',
        category = 'hotbuilding', order = 1106,},
    ['mass'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Mass")',
        category = 'hotbuilding', order = 1107,},
    ['massfab'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("MassFab")',
        category = 'hotbuilding', order = 1108,},
    ['pgen'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Pgen")',
        category = 'hotbuilding', order = 1109,},
    ['templates'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Templates")',
        category = 'hotbuilding', order = 1110,},
    ['engystation'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("EngyStations")',
        category = 'hotbuilding', order = 1111,},
    ['mml'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("MML")',
        category = 'hotbuilding', order = 1112,},
    ['mobileshield'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("MobileShields")',
        category = 'hotbuilding', order = 1113,},
    ['fieldengy'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("FieldEngy")',
        category = 'hotbuilding', order = 1114,},
    ['defense'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Defenses")',
        category = 'hotbuilding', order = 1115,},
    ['aa'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("AA")',
        category = 'hotbuilding', order = 1116,},
    ['torpedo'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Torpedo")',
        category = 'hotbuilding', order = 1117,},
    ['arties'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Arties")',
        category = 'hotbuilding', order = 1118,},
    ['tml'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("TML")',
        category = 'hotbuilding', order = 1119,},
    ['upgrades'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Upgrades")',
        category = 'hotbuilding', order = 1120,},

    -- EXTRA
    ['land_factory'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Land_Factory")',
        category = 'hotbuildingExtra', order = 1200,},
    ['air_factory'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Air_Factory")',
        category = 'hotbuildingExtra', order = 1201,},
    ['naval_factory'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Naval_Factory")',
        category = 'hotbuildingExtra', order = 1202,},
    ['quantum_gateway'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Quantum_Gateway")',
        category = 'hotbuildingExtra', order = 1203,},
    ['power_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Power_Generator")',
        category = 'hotbuildingExtra', order = 1204,},
    ['hydrocarbon_power_plant'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Hydrocarbon_Power_Plant")',
        category = 'hotbuildingExtra', order = 1205,},
    ['mass_extractor'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Mass_Extractor")',
        category = 'hotbuildingExtra', order = 1206,},
    ['mass_fabricator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Mass_Fabricator")',
        category = 'hotbuildingExtra', order = 1207,},
    ['energy_storage'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Energy_Storage")',
        category = 'hotbuildingExtra', order = 1208,},
    ['mass_storage'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Mass_Storage")',
        category = 'hotbuildingExtra', order = 1209,},
    ['point_defense'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Point_Defense")',
        category = 'hotbuildingExtra', order = 1210,},
    ['anti_air'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Anti_Air")',
        category = 'hotbuildingExtra', order = 1211,},
    ['tactical_missile_launcher'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Tactical_Missile_Launcher")',
        category = 'hotbuildingExtra', order = 1212,},
    ['torpedo_launcher'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Torpedo_Launcher")',
        category = 'hotbuildingExtra', order = 1213,},
    ['heavy_artillery_installation'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Heavy_Artillery_Installation")',
        category = 'hotbuildingExtra', order = 1214,},
    ['artillery_installation'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Artillery_Installation")',
        category = 'hotbuildingExtra', order = 1215,},
    ['strategic_missile_launcher'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Strategic_Missile_Launcher")',
        category = 'hotbuildingExtra', order = 1216,},
    ['radar_system'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Radar_System")',
        category = 'hotbuildingExtra', order = 1217,},
    ['sonar_system'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Sonar_System")',
        category = 'hotbuildingExtra', order = 1218,},
    ['omni_sensor'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Omni_Sensor")',
        category = 'hotbuildingExtra', order = 1219,},
    ['tactical_missile_defense'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Tactical_Missile_Defense")',
        category = 'hotbuildingExtra', order = 1220,},
    ['shield_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Shield_Generator")',
        category = 'hotbuildingExtra', order = 1221,},
    ['stealth_field_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Stealth_Field_Generator")',
        category = 'hotbuildingExtra', order = 1222,},
    ['heavy_shield_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Heavy_Shield_Generator")',
        category = 'hotbuildingExtra', order = 1223,},
    ['strategic_missile_defense'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Strategic_Missile_Defense")',
        category = 'hotbuildingExtra', order = 1224,},
    ['wall_section'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Wall_Section")',
        category = 'hotbuildingExtra', order = 1225,},
    ['aeon_quantum_gate_beacon'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Aeon_Quantum_Gate_Beacon")',
        category = 'hotbuildingExtra', order = 1226,},
    ['air_staging'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Air_Staging")',
        category = 'hotbuildingExtra', order = 1227,},
    ['sonar_platform'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Sonar_Platform")',
        category = 'hotbuildingExtra', order = 1228,},
    ['rapid_fire_artillery_installation'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Rapid_Fire_Artillery_Installation")',
        category = 'hotbuildingExtra', order = 1229,},
    ['quantum_optics_facility'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Quantum_Optics_Facility")',
        category = 'hotbuildingExtra', order = 1230,},
    ['engineering_station'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Engineering_Station")',
        category = 'hotbuildingExtra', order = 1231,},
    ['heavy_point_defense'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Heavy_Point_Defense")',
        category = 'hotbuildingExtra', order = 1232,},
    ['torpedo_ambushing_system'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Torpedo_Ambushing_System")',
        category = 'hotbuildingExtra', order = 1233,},
    ['perimeter_monitoring_system'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("Perimeter_Monitoring_System")',
        category = 'hotbuildingExtra', order = 1234,},
    ['t2_guided_missile'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Guided_Missile")',
        category = 'hotbuildingExtra', order = 1235,},
    ['t3_shield_disruptor'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Shield_Disruptor")',
        category = 'hotbuildingExtra', order = 1236,},
    ['t2_fighter/bomber'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Fighter/Bomber")',
        category = 'hotbuildingExtra', order = 1237,},
    ['t2_gatling_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Gatling_Bot")',
        category = 'hotbuildingExtra', order = 1238,},
    ['t2_rocket_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Rocket_Bot")',
        category = 'hotbuildingExtra', order = 1239,},
    ['t1_air_scout'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Air_Scout")',
        category = 'hotbuildingExtra', order = 1240,},
    ['t1_interceptor'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Interceptor")',
        category = 'hotbuildingExtra', order = 1241,},
    ['t1_attack_bomber'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Attack_Bomber")',
        category = 'hotbuildingExtra', order = 1242,},
    ['t2_air_transport'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Air_Transport")',
        category = 'hotbuildingExtra', order = 1243,},
    ['t1_light_air_transport'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Light_Air_Transport")',
        category = 'hotbuildingExtra', order = 1244,},
    ['t2_gunship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Gunship")',
        category = 'hotbuildingExtra', order = 1245,},
    ['t2_torpedo_bomber'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Torpedo_Bomber")',
        category = 'hotbuildingExtra', order = 1246,},
    ['t3_spy_plane'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Spy_Plane")',
        category = 'hotbuildingExtra', order = 1247,},
    ['t3_air_superiority_fighter'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Air_Superiority_Fighter")',
        category = 'hotbuildingExtra', order = 1248,},
    ['t3_strategic_bomber'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Strategic_Bomber")',
        category = 'hotbuildingExtra', order = 1249,},
    ['t1_land_scout'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Land_Scout")',
        category = 'hotbuildingExtra', order = 1250,},
    ['t1_mobile_light_artillery'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Mobile_Light_Artillery")',
        category = 'hotbuildingExtra', order = 1251,},
    ['t1_mobile_anti_air_gun'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Mobile_Anti_Air_Gun")',
        category = 'hotbuildingExtra', order = 1252,},
    ['t1_engineer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Engineer")',
        category = 'hotbuildingExtra', order = 1253,},
    ['t1_light_assault_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Light_Assault_Bot")',
        category = 'hotbuildingExtra', order = 1254,},
    ['t2_mobile_missile_launcher'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_Missile_Launcher")',
        category = 'hotbuildingExtra', order = 1255,},
    ['t1_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Tank")',
        category = 'hotbuildingExtra', order = 1256,},
    ['t2_heavy_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Heavy_Tank")',
        category = 'hotbuildingExtra', order = 1257,},
    ['t2_mobile_aa_flak_artillery'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_AA_Flak_Artillery")',
        category = 'hotbuildingExtra', order = 1258,},
    ['t2_engineer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Engineer")',
        category = 'hotbuildingExtra', order = 1259,},
    ['t3_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Tank")',
        category = 'hotbuildingExtra', order = 1260,},
    ['t3_mobile_heavy_artillery'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Mobile_Heavy_Artillery")',
        category = 'hotbuildingExtra', order = 1261,},
    ['t2_mobile_shield_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_Shield_Generator")',
        category = 'hotbuildingExtra', order = 1262,},
    ['t3_engineer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Engineer")',
        category = 'hotbuildingExtra', order = 1263,},
    ['t1_attack_boat'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Attack_Boat")',
        category = 'hotbuildingExtra', order = 1264,},
    ['t1_frigate'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Frigate")',
        category = 'hotbuildingExtra', order = 1265,},
    ['t2_destroyer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Destroyer")',
        category = 'hotbuildingExtra', order = 1266,},
    ['t2_cruiser'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Cruiser")',
        category = 'hotbuildingExtra', order = 1267,},
    ['t1_attack_submarine'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Attack_Submarine")',
        category = 'hotbuildingExtra', order = 1268,},
    ['t3_battleship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Battleship")',
        category = 'hotbuildingExtra', order = 1269,},
    ['t3_aircraft_carrier'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Aircraft_Carrier")',
        category = 'hotbuildingExtra', order = 1270,},
    ['t3_strategic_missile_submarine'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Strategic_Missile_Submarine")',
        category = 'hotbuildingExtra', order = 1271,},
    ['t3_heavy_gunship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Heavy_Gunship")',
        category = 'hotbuildingExtra', order = 1272,},
    ['t2_amphibious_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Amphibious_Tank")',
        category = 'hotbuildingExtra', order = 1273,},
    ['t1_assault_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Assault_Bot")',
        category = 'hotbuildingExtra', order = 1274,},
    ['t3_siege_assault_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Siege_Assault_Bot")',
        category = 'hotbuildingExtra', order = 1275,},
    ['t2_mobile_stealth_field_system'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_Stealth_Field_System")',
        category = 'hotbuildingExtra', order = 1276,},
    ['t2_combat_fighter'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Combat_Fighter")',
        category = 'hotbuildingExtra', order = 1277,},
    ['t3_aa_gunship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_AA_Gunship")',
        category = 'hotbuildingExtra', order = 1278,},
    ['t3_torpedo_bomber'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Torpedo_Bomber")',
        category = 'hotbuildingExtra', order = 1279,},
    ['t2_assault_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Assault_Tank")',
        category = 'hotbuildingExtra', order = 1280,},
    ['t3_sniper_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Sniper_Bot")',
        category = 'hotbuildingExtra', order = 1281,},
    ['t2_submarine_hunter'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Submarine_Hunter")',
        category = 'hotbuildingExtra', order = 1282,},
    ['t3_missile_ship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Missile_Ship")',
        category = 'hotbuildingExtra', order = 1283,},
    ['t3_heavy_air_transport'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Heavy_Air_Transport")',
        category = 'hotbuildingExtra', order = 1284,},
    ['t2_field_engineer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Field_Engineer")',
        category = 'hotbuildingExtra', order = 1285,},
    ['t3_armored_assault_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Armored_Assault_Bot")',
        category = 'hotbuildingExtra', order = 1286,},
    ['t3_mobile_missile_platform'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Mobile_Missile_Platform")',
        category = 'hotbuildingExtra', order = 1287,},
    ['t2_torpedo_boat'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Torpedo_Boat")',
        category = 'hotbuildingExtra', order = 1288,},
    ['t2_shield_boat'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Shield_Boat")',
        category = 'hotbuildingExtra', order = 1289,},
    ['t3_battlecruiser'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Battlecruiser")',
        category = 'hotbuildingExtra', order = 1290,},
    ['t1_light_gunship'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Light_Gunship")',
        category = 'hotbuildingExtra', order = 1291,},
    ['t2_mobile_bomb'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_Bomb")',
        category = 'hotbuildingExtra', order = 1292,},
    ['t2_submarine_killer'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Submarine_Killer")',
        category = 'hotbuildingExtra', order = 1293,},
    ['t2_counter_intelligence_boat'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Counter_Intelligence_Boat")',
        category = 'hotbuildingExtra', order = 1294,},
    ['t1_combat_scout'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T1_Combat_Scout")',
        category = 'hotbuildingExtra', order = 1295,},
    ['t2_assault_bot'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Assault_Bot")',
        category = 'hotbuildingExtra', order = 1296,},
    ['t2_hover_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Hover_Tank")',
        category = 'hotbuildingExtra', order = 1297,},
    ['t2_mobile_anti_air_cannon'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T2_Mobile_Anti_Air_Cannon")',
        category = 'hotbuildingExtra', order = 1298,},
    ['t3_siege_tank'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Siege_Tank")',
        category = 'hotbuildingExtra', order = 1299,},
    ['t3_mobile_shield_generator'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Mobile_Shield_Generator")',
        category = 'hotbuildingExtra', order = 1300,},
    ['t3_submarine_hunter'] = {action= 'UI_Lua import("/modules/hotbuild.lua").buildAction("T3_Submarine_Hunter")',
