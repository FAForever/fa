...
keyActions = {
    ...
    ['add_selection_set_to_selection1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add_selection_set_to_selection0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "add-selection-set-to-selection")',
        category = 'selection' },

    ['add_selection_to_selection_set1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add_selection_to_selection_set0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "add-selection-to-selection-set")',
        category = 'selection' },

    ['combine_and_select_with_selection_set1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine_and_select_with_selection_set0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "combine-and-select-with-selection-set")',
        category = 'selection' },
