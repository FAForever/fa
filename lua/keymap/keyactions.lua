...
keyActions = {
    ...
    ['add-selection-set-to-selection1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "add-selection-set-to-selection")',
        category = 'selection' },
    ['add-selection-set-to-selection0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "add-selection-set-to-selection")',
        category = 'selection' },

    ['add-selection-to-selection-set1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "add-selection-to-selection-set")',
        category = 'selection' },
    ['add-selection-to-selection-set0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "add-selection-to-selection-set")',
        category = 'selection' },

    ['combine-and-select-with-selection-set1'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(1, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set2'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(2, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set3'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(3, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set4'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(4, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set5'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(5, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set6'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(6, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set7'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(7, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set8'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(8, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set9'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(9, "combine-and-select-with-selection-set")',
        category = 'selection' },
    ['combine-and-select-with-selection-set0'] = {action = 'UI_Lua import("/lua/ui/game/selection.lua").AppendSetToSelection(0, "combine-and-select-with-selection-set")',
        category = 'selection' },
