...
keyActions = {
    ...
    ['Attack Move (not for factories)'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").AttackMoveSelectedToCurrentMousePosition(true)',
        category = 'orders', order = 15,},
    ['Attack Move (not for factories) SHIFT version'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").AttackMoveSelectedToCurrentMousePosition()',
