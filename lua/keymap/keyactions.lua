...
keyActions = {
    ...
    ['mobilearty'] = {action= 'UI_Lua import("/lua/keymap/hotbuild.lua").buildAction("Arty")',
    ...
    ['engystation'] = {action= 'UI_Lua import("/lua/keymap/hotbuild.lua").buildAction("EngyStations")',
    ...
    ['mobileshield'] = {action= 'UI_Lua import("/lua/keymap/hotbuild.lua").buildAction("MobileShields")',
    ...
    ['defense'] = {action= 'UI_Lua import("/lua/keymap/hotbuild.lua").buildAction("Defenses")',
