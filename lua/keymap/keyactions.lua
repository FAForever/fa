...
keyActions = {
    ...
    ['target_Default'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Default")',
        category = 'Weapon priorities', order = 67,},
    ['shift_target_Default'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Default")',
        category = 'Weapon priorities', order = 68,},
    ['target_ACU'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("ACU")',
        category = 'Weapon priorities', order = 69,},
    ['shift_target_ACU'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("ACU")',
        category = 'Weapon priorities', order = 70,},
    ['target_Units'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Units")',
        category = 'Weapon priorities', order = 71,},
    ['shift_target_Units'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Units")',
        category = 'Weapon priorities', order = 72,},
    ['target_PD'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("PD")',
        category = 'Weapon priorities', order = 73,},
    ['shift_target_PD'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("PD")',
        category = 'Weapon priorities', order = 74,},
    ['target_Power'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Power")',
        category = 'Weapon priorities', order = 75,},
    ['shift_target_Power'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Power")',
        category = 'Weapon priorities', order = 76,},
    ['target_Shields'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Shields")',
        category = 'Weapon priorities', order = 77,},
    ['shift_target_Shields'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Shields")',
        category = 'Weapon priorities', order = 78,},
    ['target_EXP'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("EXP")',
        category = 'Weapon priorities', order = 79,},
    ['shift_target_EXP'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("EXP")',
        category = 'Weapon priorities', order = 80,},
    ['target_Engies'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Engies")',
        category = 'Weapon priorities', order = 81,},
    ['shift_target_Engies'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Engies")',
        category = 'Weapon priorities', order = 82,},
    ['target_Arty'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Arty")',
        category = 'Weapon priorities', order = 83,},
    ['shift_target_Arty'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Arty")',
        category = 'Weapon priorities', order = 84,},
    ['target_Fighters'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Fighters")',
        category = 'Weapon priorities', order = 85,},
    ['shift_target_Fighters'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Fighters")',
        category = 'Weapon priorities', order = 86,},
    ['target_SMD'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("SMD")',
        category = 'Weapon priorities', order = 87,},
    ['shift_target_SMD'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("SMD")',
        category = 'Weapon priorities', order = 88,},
    ['target_Gunship'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Gunship")',
        category = 'Weapon priorities', order = 89,},
    ['shift_target_Gunship'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Gunship")',
        category = 'Weapon priorities', order = 90,},
    ['target_Mex'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Mex")',
        category = 'Weapon priorities', order = 91,},
    ['shift_target_Mex'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Mex")',
        category = 'Weapon priorities', order = 92,},
    ['target_Snipe'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Snipe")',
        category = 'Weapon priorities', order = 93,},
    ['shift_target_Snipe'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey("Snipe")',
        category = 'Weapon priorities', order = 94,},
