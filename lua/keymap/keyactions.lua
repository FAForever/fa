...
-- start Ghaleon
    ...
    ### HOTBUILD
    # Order start at 1100
    ['builders'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Builders')", category = 'hotbuild', order = 1101,},
    ['sensors'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Sensors')", category = 'hotbuild', order = 1102,},
    ['shields'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Shields')", category = 'hotbuild', order = 1103,},
    ['tmd'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('TMD')", category = 'hotbuild', order = 1104,},
    ['xp'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('XP')", category = 'hotbuild', order = 1105,},
    ['mobilearty'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Arty')", category = 'hotbuild', order = 1106,},
    ['mass'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Mass')", category = 'hotbuild', order = 1107,},
    ['massfab'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('MassFab')", category = 'hotbuild', order = 1108,},
    ['pgen'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Pgen')", category = 'hotbuild', order = 1109,},
    ['templates'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Templates')", category = 'hotbuild', order = 1110,},
    ['engystation'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('EngyStations')", category = 'hotbuild', order = 1111,},
    ['mml'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('MML')", category = 'hotbuild', order = 1112,},
    ['mobileshield'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('MobileShields')", category = 'hotbuild', order = 1113,},
    ['fieldengy'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('FieldEngy')", category = 'hotbuild', order = 1114,},
    ['defense'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Defenses')", category = 'hotbuild', order = 1115,},
    ['aa'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('AA')", category = 'hotbuild', order = 1116,},
    ['torpedo'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Torpedo')", category = 'hotbuild', order = 1117,},
    ['arties'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Arties')", category = 'hotbuild', order = 1118,},
    ['tml'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('TML')", category = 'hotbuild', order = 1119,},
    ['upgrades'] = {action = "UI_Lua import('/modules/hotbuild.lua').buildAction('Upgrades')", category = 'hotbuild', order = 1120,},
