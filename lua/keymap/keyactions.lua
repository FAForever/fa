...
keyActions = {
    ...
    ['PriDefault'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPriorities({0})',
        category = 'Weapon priorities', order = 67,},
    ['shift_PriDefault'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPriorities({0})',
        category = 'Weapon priorities', order = 68,},
    ['Custom1'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(1)',
        category = 'Weapon priorities', order = 69,},
    ['shift_Custom1'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(1)',
        category = 'Weapon priorities', order = 70,},
    ['Custom2'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(2)',
        category = 'Weapon priorities', order = 71,},
    ['shift_Custom2'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(2)',
        category = 'Weapon priorities', order = 72,},
    ['Custom3'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(3)',
        category = 'Weapon priorities', order = 73,},
    ['shift_Custom3'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(3)',
        category = 'Weapon priorities', order = 74,},
    ['Custom4'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(4)',
        category = 'Weapon priorities', order = 75,},
    ['shift_Custom4'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(4)',
        category = 'Weapon priorities', order = 76,},
    ['Custom5'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(5)',
        category = 'Weapon priorities', order = 77,},
    ['shift_Custom5'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(5)',
        category = 'Weapon priorities', order = 78,},
    ['Custom6'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(6)',
        category = 'Weapon priorities', order = 79,},
    ['shift_Custom6'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(6)',
        category = 'Weapon priorities', order = 80,},
    ['Custom7'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(7)',
        category = 'Weapon priorities', order = 81,},
    ['shift_Custom7'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(7)',
        category = 'Weapon priorities', order = 82,},
    ['Custom8'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(8)',
        category = 'Weapon priorities', order = 83,},
    ['shift_Custom8'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(8)',
        category = 'Weapon priorities', order = 84,},
    ['Custom9'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(9)',
        category = 'Weapon priorities', order = 85,},
    ['shift_Custom9'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(9)',
        category = 'Weapon priorities', order = 86,},
    ['Custom10'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(10)',
        category = 'Weapon priorities', order = 87,},
    ['shift_Custom10'] = {action = 'UI_Lua import("/lua/keymap/misckeyactions.lua").SetWeaponPrioritiesHotkey(10)',
