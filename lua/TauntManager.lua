...
function CreateTauntManager(name, fileName)
    local tManager = {
                ...
                {
                    {
                        ...
                        Value = aibrain_methodsGetBlueprintStat(brain, 'Units_History',category) + number,
                        Category = category,
                    },
                }
            )
                ...
                {
                    {
                        ...
                        CompareType = 'GreaterThanOrEqual',
                        Value = aibrain_methodsGetBlueprintStat(brain, 'Units_History', category) + 1,
                        Category = category,
                    },
                }
            )
                ...
                {
                    {
                        ...
                        CompareType = 'GreaterThanOrEqual',
                        Value = aibrain_methodsGetBlueprintStat(brain, 'Units_Killed',category) + number,
                        Category = category,
                    },
                }
            )
                ...
                {
                    {
                        ...
                        CompareType = 'GreaterThanOrEqual',
                        Value = aibrain_methodsGetBlueprintStat(brain, 'Enemies_Killed',category) + number,
                        Category = category,
                    },
                }
            )
        ...
        PlayTaunt = function(self,tauntNum)
            ...
            if tableGetn(possibleTaunts) == 0 then
                return
            end

            if not self.TauntsLocked then
                local num = Random(1,tableGetn(possibleTaunts))
