...
function PreModBlueprints(all_bps)
    ...
    for _, bp in all_bps.Unit do
        ...
        local modGSR = not (bp.AI and bp.AI.GuardScanRadius) and (
                       ...
                       (bp.CategoriesHash.STRUCTURE and (bp.CategoriesHash.DIRECTFIRE or bp.CategoriesHash.INDIRECTFIRE) and (bp.CategoriesHash.DEFENSE or bp.CategoriesHash.ARTILLERY))
                       )
