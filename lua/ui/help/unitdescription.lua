...
Description = {
   ...
   -- COMMANDERS  
   ['uel0001']      = "<LOC Unit_Description_0303> Armored Commander. Combination barracks and command center. Contains all the blueprints necessary to build a basic army from scratch. Upgradeable with combat enhancements, advanced engineering suits, resource allocation system, and teleporting.",
   ...
   -- COMMANDERS     
   ['url0001'] = "<LOC Unit_Description_0304> Armored Commander. Combination barracks and command center. Contains all the blueprints necessary to build a basic army from scratch. Upgradeable with combat enhancements, advanced engineering suits, resource allocation system, and teleporting.",
   ...
   -- COMMANDERS     
   ['ual0001'] = "<LOC Unit_Description_0305> Armored Commander. Combination barracks and command center. Contains all the blueprints necessary to build a basic army from scratch. Upgradeable with combat enhancements, advanced engineering suits, resource allocation system, and teleporting.",
   ...
   ['uab3104'] = "<LOC Unit_Description_0302> High-end intelligence system. Provides maximum radar and sonar coverage. Counters enemy intelligence systems.", 
    ...
    -- COMMANDERS
    ['xsl0001'] = "<LOC Unit_Description_0420> Armored Commander. Combination barracks and command center. Contains all the blueprints necessary to build a basic army from scratch. Upgradeable with combat enhancements, advanced engineering suits, resource allocation system, and teleporting.",
