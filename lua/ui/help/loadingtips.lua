...
Tips = {
    ...
    "<LOC loadingtip_0035>Overcharge can deal up to 15,000 damage to a unit, requiring 67k energy capacity",
    ...
    "<LOC loadingtip_0044>Overcharge will drain a maximum of 90% of stored energy, Unless you only have 5k Energy then it will drain everything",  
}
