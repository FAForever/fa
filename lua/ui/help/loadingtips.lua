...
Tips = {
    ...
    "<LOC loadingtip_0045>Use military units (especially tanks on most maps) to take mexes/territory and counter the enemy"
    ...
    "<LOC loadingtip_0058>If scout enough, you should know what the enemy makes and can generally try to counter it"
    ...
    "<LOC loadingtip_0072>It can be worthwhile to kill/reclaim your old low-tech units to have additional nass"
    ...
    "<LOC loadingtip_0083>You may want to try UI mods like NoShake, Advanced Target Priorities 1.1, Rheclaim, etc"
    "<LOC loadingtip_0085>You can search on the vault for numerous UI mods to try, like HotBuild Overhaul or icon mods"
