...
Tips = {
    ...
    "<LOC loadingtip_0014>Place a move order in the vicinity before building a structure to make use of the build range",
    "<LOC loadingtip_0015>The Uashavoh is the only destroyer that can be submerged",
    ...
    "<LOC loadingtip_0027>Protect your T1 Point Defences with walls",
