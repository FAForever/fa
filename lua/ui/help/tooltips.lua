...
Tooltips = {
    ...
    sacu_loadout_queue = {
        title = "<LOC tooltipui2002>Queue SACU loadout",
        description = "<LOC tooltipui2003>Queue a SACU with the upgrades selected on the enhancement tab. Shift-click queues 5.",
    },
    toggle_area_assist = {
