...
function SetLayout()
    ...
    LayoutHelpers.AtLeftTopIn(controls.ReclaimGroup, controls.bg, 178, 58)
    ...
    LayoutHelpers.AtVerticalCenterIn(controls.ReclaimGroup.EnergyText, controls.ReclaimGroup.EnergyIcon, 0)
