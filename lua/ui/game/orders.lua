...
local CreatePrioMain = import('/lua/ui/dialogs/priorities.lua').createPrioMain
...
function UpdatePriData()
    mainData = Prefs.GetFromCurrentProfile("mainPriData")
end
    ...
    while true do
        if unitList[1] and not IsDestroyed(control) then
            ...
            elseif prioStateTextures[priority] then
                ...
                LayoutHelpers.AtCenterIn(control.prioState.text, control.prioState, 0, 0)
