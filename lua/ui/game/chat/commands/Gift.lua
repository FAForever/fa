...
-------------------------------------------------------------------------------
-- /gift <target> — transfer the current selection to an allied player.
...
Command = {
    ...
    Accept = function(args)
        ...
        if focusArmy == -1 then
            return false, "/gift: observers can't gift units."
        end
