...
local histo={
        main_histo={ 
			...
			[3]={name="units built",icon=mySkinnableFile("/game/unit_view_icons/build.dds"),label1="built",label2="",link="built_histo",Tooltip="built_units",
				data={{name="air unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/fighter_generic.dds"),path={"units","air","built"},color="39b0be",Tooltip="air"},
					{name="land unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/land_generic.dds"),path={"units","land","built"},color="64421a",Tooltip="land"},
					{name="naval unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/ship_generic.dds"),path={"units","naval","built"},color="000080",Tooltip="naval"},
					{name="xp unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/experimental_generic.dds"),path={"units","experimental","built"},color="641a5e",Tooltip="xp"},
					{name="cdr unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/commander_generic.dds"),path={"units","cdr","built"},color="white",Tooltip="cdr"},
					{name="structures",icon=UIUtil.UIFile("/hotstats/icons_strategic/factory_generic.dds"),path={"units","structures","built"},color="3b3b3b",Tooltip="struct"} }},					
			 [4]={name="units kills",icon=mySkinnableFile("/game/unit_view_icons/kills.dds"),label1="kills",label2="",Tooltip="kills_units",link="kills_histo",
				data={{name="air unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/fighter_generic.dds"),path={"units","air","kills"},color="39b0be",Tooltip="air"},
					{name="land unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/land_generic.dds"),path={"units","land","kills"},color="64421a",Tooltip="land"},
					{name="naval unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/ship_generic.dds"),path={"units","naval","kills"},color="000080",Tooltip="naval"},
					{name="xp unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/experimental_generic.dds"),path={"units","experimental","kills"},color="641a5e",Tooltip="xp"},
					{name="cdr unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/commander_generic.dds"),path={"units","cdr","kills"},color="white",Tooltip="cdr"},
					{name="structures",icon=UIUtil.UIFile("/hotstats/icons_strategic/factory_generic.dds"),path={"units","structures","kills"},color="3b3b3b",Tooltip="struct"} }},
			 },
	mass_histo={[1]={name="mass",icon=UIUtil.UIFile("/hotstats/score/mass-in-icon.dds"),label1="in",label2="",Tooltip="Mass_incoming",link="main_histo",
	...
	energy_histo={[1]={name="energy",icon=UIUtil.UIFile("/hotstats/score/energy-in-icon.dds"),label1="in",label2="",Tooltip="Energy_incoming",link="main_histo",
	...
	built_histo={[1]={name="units built",icon=UIUtil.UIFile("/hotstats/score/fighter-icon.dds"),label1="air",label2="",Tooltip="air",link="main_histo",
				data={{name="air unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/fighter_generic.dds"),path={"units","air","built"},color="39b0be",Tooltip="air"}}},
				[2]={name="units built",icon=UIUtil.UIFile("/hotstats/score/land-icon.dds"),label1="land",label2="",Tooltip="land",link="main_histo",
				data={{name="land unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/land_generic.dds"),path={"units","land","built"},color="64421a",Tooltip="land"}}},
				[3]={name="units built",icon=UIUtil.UIFile("/hotstats/score/ship-icon.dds"),label1="naval",label2="",Tooltip="naval",link="main_histo",
				data={{name="naval unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/ship_generic.dds"),path={"units","naval","built"},color="000080",Tooltip="naval"}}},
				[4]={name="units built",icon=UIUtil.UIFile("/hotstats/score/experimental-icon.dds"),label1="xp",label2="",Tooltip="xp",link="main_histo",
				data={{name="cdr unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/commander_generic.dds"),path={"units","cdr","built"},color="white",Tooltip="cdr"}},
				data={{name="xp unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/experimental_generic.dds"),path={"units","experimental","built"},color="641a5e",Tooltip="xp"}}},
				...
				data={{name="structures",icon=UIUtil.UIFile("/hotstats/icons_strategic/factory_generic.dds"),path={"units","structures","built"},color="3b3b3b",Tooltip="struct"} }}
			 },
	kills_histo={[1]={name="units kills",icon=UIUtil.UIFile("/hotstats/score/fighter-icon.dds"),label1="air",label2="",Tooltip="air",link="main_histo",
				data={{name="air unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/fighter_generic.dds"),path={"units","air","kills"},color="39b0be",Tooltip="air"}}},
				[2]={name="units kills",icon=UIUtil.UIFile("/hotstats/score/land-icon.dds"),label1="land",label2="",Tooltip="land",link="main_histo",
				data={{name="land unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/land_generic.dds"),path={"units","land","kills"},color="64421a",Tooltip="land"}}},
				[3]={name="units kills",icon=UIUtil.UIFile("/hotstats/score/ship-icon.dds"),label1="naval",label2="",Tooltip="naval",link="main_histo",
				data={{name="naval unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/ship_generic.dds"),path={"units","naval","kills"},color="000080",Tooltip="naval"}}},
				[4]={name="units kills",icon=UIUtil.UIFile("/hotstats/score/experimental-icon.dds"),label1="xp",label2="",Tooltip="xp",link="main_histo",
				data={{name="cdr unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/commander_generic.dds"),path={"units","cdr","kills"},color="white",Tooltip="cdr"}},
				data={{name="xp unit",icon=UIUtil.UIFile("/hotstats/icons_strategic/experimental_generic.dds"),path={"units","experimental","kills"},color="641a5e",Tooltip="xp"}}},
				...
				data={{name="structures",icon=UIUtil.UIFile("/hotstats/icons_strategic/factory_generic.dds"),path={"units","structures","kills"},color="3b3b3b",Tooltip="struct"} }}
			 },
