...
gamePatches = {
    ...
    },
    {
        ...
        description = {
            ...
            "## Balance",
            "",
            "- (#6921) Decrease Salem's anti-torpedo flares' target check interval from 1.0s to 0.4s (the default for anti-projectile weapons). This makes ",
            "it more likely to detect torpedoes and fire the flares in time, especially against torpedo bombers.",
            "",
    ...
    {        
        ...
        description = {
            ...
            "",
            "In general the Fatboy has been in an awkward position for a while now. With these changes we try to mitigate some of the ",
            "perceived issues while preserving the identity of the Fatboy.",
            "",
            ...
            "  - SizeZ: 8.0 -> 7.2",
            "",
            "- (#6360) Increase the hitboxes of a wide range of units to fix them being able to evade torpedoes due to their hitbox being ",
            "  too shallow. Lots of units, such as ships or Cybran/UEF engineers, have part of their hitboxes below ground level to enable ",
            "  torpedo weapons to damage them when on water. Prior to this PR however, the hitboxes of many units were not submerged deep ",
            "  enough into the water, which caused torpedoes to not be able to hit them reliably. This was the case for almost 30 units, ",
            "  most notably the Cooper, but also all movable and immovable Sonars.",
            "",
            ...
            "",
            "  This change does have balance implications, especially in the case of the Cooper, since the bug caused this unit to receive ",
            "  damage from torpedoes both later and less often.",
            "",
            "## Features",
            "",
            "- (#6309) The movement speed of transports now changes based on how many and which types of units they have loaded.",
            "",
            "  - Units slow down transports based on their `TransportSpeedReduction` stat. If a unit has a `TransportSpeedReduction` of 1, ",
            "  each instance of this unit will slow down the transport's `MaxAirspeed` by 1. The primary implication of this change is that ",
            "  the effectiveness of the currently too oppressive Zthuee drops is reduced in an intuitive way. The effectiveness of ACU drops ",
            "  via Tech 2 transports remains unchanged.",
            "",
            ...
            "",
            "- (#6309) Display the `TransportSpeedReduction` stat in the additional unit details displayed when `Show Armament Detail in ",
            "Build Menu` is enabled in the settings.",
            "",
            "- (#6363) When an army is defeated, transfer all unbuilt units instead of only Experimentals and T3 Arty.",
            "  - When a unit fails to rebuild because its build site was blocked (for example a unit in factory), the mass invested is ",
            "    returned as a wreck.",
            "",
            "## Bug fixes",
            "",
            ...
            "",
            "- (#6329) Fix the selection box of the Uyanah (Seraphim T3 Lightning Tank) being unusually thin. Fix the life bar and selection ",
            "box of the Vulthoo (Seraphim T2 Gunship) not lining up with its model. The Vulthoo was made physically larger in a previous ",
            "patch.",
            "",
            "AI - Fixed a bug with recording a platoon's plan and certain other platoon related logic",
            "",
            "- (#6337) Fixed a bug where HotBuild keybindings did not reset to the first unit/building in the cycle when the key was pressed ",
            "again.",
    ...
    },
    {
        ...
        description = {
            ...
            "",
            "Because of the time and effort of a wide range of contributors we now have one of the largest game patches since a long ",
            "time. In general there have been good and constructive conversations between contributors that brought us to this ",
            "point. And I'd like to show my sincere appreciation towards those contributors for making this possible. This does not only ",
            "apply to contributors of the game team, it applies to all contributors that took part in discussions.",
            "",
            "As people come to help and contribute, so do people eventually go and move on. I've been the game team lead the past ",
            "three years and in general I think my contributions have been a net positive towards the FAForever project. However, ",
            "I could not have done it without the help of a wide range of contributors - whom I will not name in fear of forgetting ",
            "someone. Just as I appreciate the discussions that brought us this patch, so did I appreciate the same welcoming ",
            "environment between contributors the past three years. ",
            "",
            "And as my motivation to contribute towards the FAForever project dwindles I've decided to proceed to step down as the lead ",
            "of the game team. This created a window for contributors to step up and eventually BlackYps decided to do so. He's been ",
            "contributing towards the FAForever project for several years now. He's a board member of the association. In general ",
            "he has the right character and intentions. And I am looking forward to what he'll do with the role.",
            "",
            "As mentioned before, the in-game will no longer include all the details of the changes. You can find the complete ",
            "changelog on Github. You can use the button in the bottom-left corner of this dialog to immediately jump to ",
            "details of the changes of the selected game version.",
