...
gamePatches = {
    {
        ...
        description = {
            ...
            "",
            "With the last patch walls now work reliable to block projectiles, even for units that are hiding behind them. This ",
            "can create almost impenetrable defenses without the use of artillery. Together with the balance team we decided to ",
            "push the balance changes of walls forward. These changes apply to all wall sections:",
            "",
            "- - Health: X -> 500",
            ...
            "",
            "With the last patch units would no longer rotate towards the best roll off point at the end of construction. ",
            "Especially for large units (read: naval units) it could look quite odd. We now make an exception to engineers as a ",
            "wrong oriented engineer at the start of the game can easily slow down your build order with several seconds.",
            "",
            "### AI",
            "",
            "- (#5621) Improve 'PathToWithThreatThreshold' to also return where it found threat",
            "- (#5621) Introduce 'DirectionsFromWithThreatThreshold' to be able to retrieve a save landing location",
            "- (#5607) Fix the 'GetPositionsInRadius' to work with the new coarse graph",
            "- (#5608) The easy AI now works again",
            "",
            "## Bug fixes",
            "",
            "- (#5618) Fix the missing energy requirements for Overcharge",
            "- (#5606) Hide the collapse button of the mass fabrication panel when using the 'UI_ToggleGamePanels' console command",
            "- (#5620) Experimental mobile factories can now be selected while being constructed again",
            "- (#5619) The projectiles of the AA guns of the Cybran carrier have a trail again",
            "- (#5615) Show the backpack of the UEF ACU when the bubble shield enhancement is installed",
            "- (#5611) Fix an edge case that could prevent the Cybran Microwave Laser from firing",
            "- (#5610) Fix factory modules (of mobile factories) of bugging out campaign objectives",
            "",
            "They are still part of the objective. It is up to the author of the campaign map to exclude them in the script files ",
            "if they do not want them to be part of the objective",
            "",
            "- (#5610) Fix Zappers (Cybran TMD) of intersecting the wrong missiles",
            "- (#xyzw) Fix animation rate of walking animation of various units",
            "",
            "## Other changes",
            "",
            "- (#5616) Re-introduce Seraphim specific scorchsplats",
            "- (#5613) Store the damage of the claw of the Colossus in the blueprint",
            "",
            "This makes it easier to mod.",
            "",
            "- (#5614) Store the map-wide albedo for shaders in the same slot",
            "",
            "This makes it easier to switch terrain shaders.",
            "",
            "## Contributors",
            "",
