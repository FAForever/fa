...
function SetLayout()
    ...
    controls.bg.leftBrace:SetTexture(UIUtil.SkinnableFile('/game/resource-panel/bracket-left_bmp.dds'))
    controls.bg.leftGlow:SetTexture(UIUtil.SkinnableFile('/game/resource-panel/bracket-energy-l_bmp.dds'))
