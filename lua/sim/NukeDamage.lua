NukeAOE = Class() {
    ...
    DoNukeDamage = function(self, instigator, pos, brain, army)
        if self.TotalTime == 0 then
            import('/lua/sim/DamageArea.lua').DamageArea(instigator, pos, self.Radius, self.Damage, 'Nuke', true, true, brain, army)
        else
