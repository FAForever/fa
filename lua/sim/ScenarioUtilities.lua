...
function CreatePlatoons(strArmy, tblNode, tblResult, platoonList, currPlatoon, treeResult, balance)
    ...
    local currTemplate
    ---@type integer? # Number of field sof the Platoon template
    local numRows
    ---@type PlatoonName?
...
---@return table<UnitName, Unit> unitList
---@return table<PlatoonName, Platoon> platoonList
---@overload fun(strArmy: ArmyName, strGroup: GroupName, wreckage: true, balance?: boolean)
function CreateArmyGroup(strArmy, strGroup, wreckage, balance)
    ...
    -- When tblResult isn't nil, the other returned values from CreatePlatoon also exist
    ---@cast tblResult -nil
    ---@cast treeResult -nil
    ---@cast platoonList -nil
    if wreckage then
