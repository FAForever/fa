...
SBOOhwalliBombEffectController01 = Class(NullShell) {
    ...
    CreateRifts = function(self, army)
        ...
        for i = 0, (num_projectiles - 1) do
            ...
            local proj = self:CreateProjectile(BaseRingRiftEffects[RandomInt(1, 3)], xVec * 1.2, 2, zVec * 1.2, xVec, 0,
                zVec)
    ...
    MainBlast = function(self, army)
        ...
        local plume = self:CreateProjectile('/effects/entities/SBOOhwalliBombEffect02/SBOOhwalliBombEffect02_proj.bp', 0
            , 3, 0, 0, 0, 0)
