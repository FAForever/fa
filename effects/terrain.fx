...
// For compatibility reasons we still provide the old Terrain301 shader until the neroxis map generator
// has been updated to use Terrain250 instead. This shader is scheduled to be removed in the next game version
